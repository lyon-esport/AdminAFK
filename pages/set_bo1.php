...
<html>
	...
	<body>
		<div class= "page-wrap">
			...
			<div class="container">
				<br>
				<h1 class="text-center">Set multiple Bo1</h1>
				<br>
				<h6 class="text-center">Set multiple matches with range of ID</h6>
				<br>
			</div>
			<div class="container">
			<?php
			...
			<form method="post" action="../traitement/script_set_bo1.php">
				<div class="container">
					  <div class="form-row">
						<div class="col">
						...
						<div class="col">
						  ...
						  <input type="number" name="last_id" class="form-control" placeholder="18" min="1" pattern=".{1,}" required title="1 character minimum">
						</div>
					  </div>
					  <div class="form-row">
						<div class="col">
						  <label for="rules">Config</label>
						  <input type="text" name="rules" class="form-control" <?php if(isset($CONFIG['default_ebot_rules'])){echo "value='", $CONFIG['default_ebot_rules'],"' ";}?> placeholder="dh" pattern=".{1,}" required title="1 character minimum">
						</div>
						<div class="col">
					  ...
					  <div class="form-row">
						<div class="col">
						  ...
						  <select id="overtime_mmr" name="overtime_mmr" class="form-control">
								...
								{
									if($CONFIG['default_ebot_over_mmr'] == 5)
									{
