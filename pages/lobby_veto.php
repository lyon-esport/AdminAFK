		...
		if($embed == false)
		{
			...
			echo '<div class="container">';
				echo '<div class="input-group mb-3">';
				  echo '<input type="password" id="copy" class="form-control" value="'.$url.'" placeholder="URL of map veto" aria-label="URL of map veto" aria-describedby="basic-addon2" readonly>';
				  echo '<div class="input-group-append">';
					echo '<button id="button_show" class="btn btn-outline-secondary" type="button" onclick="show()">Show</button>';
					echo '<button id="button_copy" class="btn btn-outline-secondary" type="button" onclick="copy()">Copy</button>';
				  echo '</div>';
				echo '</div>';
			echo '</div>';
			///////////////////////////
