			...
			echo '<form method="post" action="../traitement/create_lobby_veto.php">';	
				...
				echo '<div class="container">';
					...
					echo '<div class="col text-center">';
						echo '<img id="de_dust2" src="../images/veto/de_dust2.jpg" class="map veto_map rounded" alt="Dust2">';
						echo "<input id='de_dust2_hidden' name='de_dust2' type='hidden' value='yes'>";
						echo '&nbsp';
						echo '<img id="de_cache" src="../images/veto/de_cache.jpg" class="map veto_map rounded" alt="Cache">';
						echo "<input id='de_cache_hidden' name='de_cache' type='hidden' value='yes'>";
						echo '&nbsp';
						echo '<img id="de_mirage" src="../images/veto/de_mirage.jpg" class="map veto_map rounded" alt="Mirage">';
						echo "<input id='de_mirage_hidden' name='de_mirage' type='hidden' value='yes'>";
						echo '&nbsp';
						echo '<img id="de_inferno" src="../images/veto/de_inferno.jpg" class="map veto_map rounded" alt="Inferno">';
						echo "<input id='de_inferno_hidden' name='de_inferno' type='hidden' value='yes'>";
					echo '</div>';
					echo '<br>';
					echo '<div class="col text-center">';
						echo '<img id="de_overpass" src="../images/veto/de_overpass.jpg" class="map veto_map rounded" alt="Overpass">';
						echo "<input id='de_overpass_hidden' name='de_overpass' type='hidden' value='yes'>";
						echo '&nbsp';
						echo '<img id="de_cobblestone" src="../images/veto/de_cobblestone.jpg" class="map veto_ban rounded" alt="Cobblestone">';
						echo "<input id='de_cobblestone_hidden' name='de_cobblestone' type='hidden' value='no'>";
						echo '&nbsp';
						echo '<img id="de_nuke" src="../images/veto/de_nuke.jpg" class="map veto_map rounded" alt="Nuke">';
						echo "<input id='de_nuke_hidden' name='de_nuke' type='hidden' value='yes'>";
						echo '&nbsp';
						echo '<img id="de_train" src="../images/veto/de_train.jpg" class="map veto_map rounded" alt="Train">';
