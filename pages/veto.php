			...
			echo '<form method="post" action="../traitement/create_lobby_veto.php">';	
				...
				echo '<div class="container'.$before_embed.'">';
					...
					echo '<div class="col text-center">';
						...
						echo '<img id="de_mirage" src="../images/veto/de_mirage.jpg" class="map veto_map rounded special_veto" alt="Mirage">';
						echo "<input id='de_mirage_hidden' name='de_mirage' type='hidden' value='yes'>";
						echo '<img id="de_inferno" src="../images/veto/de_inferno.jpg" class="map veto_map rounded special_veto" alt="Inferno">';
                        ...
                        echo '<img id="de_vertigo" src="../images/veto/de_vertigo.jpg" class="map veto_map rounded special_veto" alt="Vertigo">';
                        echo "<input id='de_vertigo_hidden' name='de_vertigo' type='hidden' value='yes'>";
                        echo '<img id="de_cache" src="../images/veto/de_cache.jpg" class="map veto_ban rounded special_veto" alt="Cache">';
                        echo "<input id='de_cache_hidden' name='de_cache' type='hidden' value='no'>";
